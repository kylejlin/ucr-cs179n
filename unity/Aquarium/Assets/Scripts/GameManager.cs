...
public class GameManager : MonoBehaviour
{
    ...
    void Start()
    {
       // aquarium = GameObject.Find("Aquarium"); // this will have to be changed: it should be spawned, not referenced, but this is convenient for the MVP
        Entity trilo = aquarium.addEntity(trilobite, new Vector3(1,5,0), Quaternion.identity);
        Entity alg = aquarium.addEntity(algea, new Vector3(1, 5, 1), Quaternion.identity);
